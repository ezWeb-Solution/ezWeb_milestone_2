...
app.post("/updateContent", async (req, res) => {
  ...
  //obtaining Wordpress authentication
...
app.get("/generateSite", async (req, res) => {
 ...
 //creating new application with the assigned url as label
  ...
  fetch('https://api.cloudways.com/api/v1/security/lets_encrypt_install', {
    method: 'POST',
    headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'Accept': 'application/json'
    },
    body: `server_id=${serverId}&app_id=${wantedId}&ssl_email=websitegurusingapore%40gmail.com&wild_card=true&ssl_domains[]=www.${url}.ezwebs.xyz`
  });
